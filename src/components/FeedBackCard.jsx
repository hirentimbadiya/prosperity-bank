    ...
    >
      ...
      <div className="flex flex-row items-center justify-center">
        ...
        <div className="flex flex-col">
          <h4 className="text-white font-poppins font-semibold text-[20px] leading-8">{name}</h4>
          <p className=" text-dimWhite font-poppins font-normal text-[15px] leading-6 "> {title}</p>
        </div>
      </div>
    </div>
  );
