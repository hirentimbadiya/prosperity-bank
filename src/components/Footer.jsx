    ...
    <section className={`${styles.flexCenter} ${styles.paddingY} flex-col`}>
      <div className={`${styles.flexStart} md:flex-row flex-col mb-8 w-full`}>
        <div className="flex flex-1 flex-col justify-start mr-10">
          ...
          />
          <p className={`${styles.paragraph} max-w-[350px] mt-3`}>A new way to make the payments easy, reliable and secure.</p>
        </div>

        <div className="flex flex-[1.5] w-full flex-row 
        justify-between flex-wrap md:mt-0 mt-10">
          {footerLinks.map((foot) => (
            <div key={foot.key} className="flex flex-col ss:my-0 my-0 min-w-[150px]">
              ...
              <ul className="list-none mt-4">
                {foot.links.map((link , index) => (
                  <li key={link.name} className={`font-poppins font-noraml 
